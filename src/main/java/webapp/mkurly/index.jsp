...
<link rel="stylesheet" href="${contextPath}/mkurly/css/index.css">
<link rel="stylesheet" href="${contextPath}/mkurly/css/index2.css">
...
<header>
 ...
 <!--메인페이지 영역 시작-->
    <div class="allmainform">
        <div class="allindexform">
            ...
            <div class="indexform">
                            ...
                            <div class="mainswiper">
                                <div class="mainswiperwrapper">
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (1).jpg" alt="상품">
                                                <div>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (2).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (3).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (4).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (5).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (6).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (7).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (8).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (9).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (10).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (11).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (12).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (13).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (14).jpg" alt="상품">
                                                <div>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (15).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/이 상품 어때요/how (16).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                ...
                <div class="mainspace">
                    <div class="mainarea">
                        <img src="${contextPath}/mkurly/컬리이미지/메인페이지/광고.jpg" alt="광고">
                    </div>
                </div>
                <div class="mainspace">
                    <div class="mainarea">
                            ...
                            <div class="allimgarea">
                                <div class="otherswiperwrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/일본미식여행/japan (1).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/일본미식여행/japan (2).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/일본미식여행/japan (3).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/일본미식여행/japan (4).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                ...
                                <div class="allimgarea">
                                    <div class="otherswiperwrapper" style="transform: translate3d(0px, 0px, 0px);">
                                        <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                            <div class="imgdivide">
                                                <div class="imgcontainer imgcontainerhidden">
                                                    <a href="productDetailPage.html"><img src="${contextPath}/mkurly/컬리이미지/채소/vegetable6.jpg" alt="상품이미지"></a>
                                                    <div>
                                                        <button class="cartbutton cartbuttonposition">
                                                            <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                        </button>
                                        ...
                                        <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                            <div class="imgdivide">
                                                <div class="imgcontainer imgcontainerhidden">
                                                    <img src="${contextPath}/mkurly/컬리이미지/채소/vegetable4.jpg" alt="상품">
                                                    <div>
                                                        <button class="cartbutton cartbuttonposition">
                                                            <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                        </button>
                                        ...
                                        <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                            <div class="imgdivide">
                                                <div class="imgcontainer imgcontainerhidden">
                                                    <img src="${contextPath}/mkurly/컬리이미지/채소/vegetable2.jpg" alt="상품">
                                                    <div>
                                                        <button class="cartbutton cartbuttonposition">
                                                            <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                        </button>
                                        ...
                                        <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                            <div class="imgdivide">
                                                <div class="imgcontainer imgcontainerhidden">
                                                    <img src="${contextPath}/mkurly/컬리이미지/채소/vegetable1.jpg" alt="상품">
                                                    <div>
                                                        <button class="cartbutton cartbuttonposition">
                                                            <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                        </button>
                            ...
                            <div class="allimgarea">
                                <div class="otherswiperwrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/컬리 추천 샌드위치/send (1).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/컬리 추천 샌드위치/send (2).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/컬리 추천 샌드위치/send (3).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                                    ...
                                    <div class="swiperslide" style="width: 249px; margin-right: 18px;">
                                        <div class="imgdivide">
                                            <div class="imgcontainer imgcontainerhidden">
                                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/컬리 추천 샌드위치/send (4).jpg" alt="상품">
                                                <div>
                                                    <button class="cartbutton cartbuttonposition">
                                                        <img src="data:image/svg+xml;base64," alt="장바구니 아이콘">
                                                    </button>
                    ...
                    <div class="view">
                        <div class="rail-area">
                            <div class="kurly-rail">
                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/movekurly 복사.png" alt="이미지레일">
                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/movekurly 복사.png" alt="이미지레일">
                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/movekurly 복사.png" alt="이미지레일">
                                <img src="${contextPath}/mkurly/컬리이미지/메인페이지/movekurly 복사.png" alt="이미지레일">
                            </div>
                                ...
                                <div class="otherswiperwrapper" style="transform: translate3d(0px, 0px, 0px);">
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta1.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta2.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta3.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta4.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta5.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                    <div class="swiperslide" style="width: 160px; margin-right: 18px;">
                                        <div class="instaimgarea">
                                            <img class="instaimg" src="${contextPath}/mkurly/컬리이미지/insta/insta6.jpg" alt="인스타그램 리뷰 사진">
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="footer-top-frame">
            <div class="footer-serviceCenter-inquiry">
                <div class="top-left-footer">
                    <a href="${contextPath}/help/listHelp.do">
                        <h2>고객행복센터</h2>
    ...
    <script src="${contextPath}/mkurly/js/index.js"></script>
</body>
</html>