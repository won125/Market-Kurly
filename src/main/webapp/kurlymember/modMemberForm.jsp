...
function removeMember(obj) { //게시글 목록으로 돌가가는 함수
	if(confirm("탈퇴하시겠습니까?")){
		obj.action = "${contextPath}/member/removeMember.do";
		obj.submit();
	}
}
function updateMember(obj) { //게시글 목록으로 돌가가는 함수
	if(confirm("수정하시겠습니까?")){
...
<header>
	...
	<form name="frmJoinForm" class="userjoin">
		<div class="allmemberjoinform">
		    ...
		    <div class="middlememberjoinform">
		        ...
		        <div class="whitespace">
		        	...
		        	<div class="joinspace">
			            <button id="joinBtn" class="joinbutton" type="button" width="240" height="56" radius="3" onclick="removeMember(this.form)">
			                <span class="sentencedoublecheck">탈퇴하기</span>
			            </button>
	            	</div> 
		            <div class="joinspace">
			            <button id="joinBtn" class="joinbutton" type="button" width="240" height="56" radius="3" onclick="updateMember(this.form)">
