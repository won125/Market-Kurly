        ...
        <div id="container" class="mainnewproductform">
            <div class="headbanner">
                <a href="https://www.kurly.com/shop/event/kurlyEvent.php?htmid=event/2022/0207/new_products">
                    <img src="${contextPath}/컬리이미지/배너-신상품/headbanner.webp" alt="배너이미지" class="bannerimg">
                </a>
            </div>
                   ...
                   <c:forEach var="goods" items="${glist}">
                            ...
                            <div class="newproductcontent">
                                    ...
                                    <div class="realnewproductarea">
                                        <div class="realnewproduct">        <!--goodsselect-->
                                            <a href="${contextPath}/good1/goodsdetail.do?goodscode=${goods.goodscode}"><img src="${contextPath}/컬리이미지/${goods.goodsimage}" alt="상품이미지"></a>
                                            <div>
                                    ...
                                    <input type="hidden" value="${goods.goodscode}">
