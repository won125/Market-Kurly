...
<body>
			...
			<script type="text/javascript">
				function addwish(obj) {
					let goodscode = document.getElementById("goodscode");
					obj.action="${contextPath}/addwish.do?id=${sessionID}&goodscode="+goodscode;
					obj.submit();
    ...
    <main class="main-frame">
        ...
        <form>
            ...
            <input type="hidden" id="goodscode" value="">
                <div class="left-img-area"><img src="${contextPath}/컬리이미지/채소/vegetable6.jpg" alt="가지상세이미지"></div>
                ...
                <div class="right-information-area">
                    <div>
                        ...
                        <div class="title-area">
                            ...
                            <p>믿고 먹을 수 있는 상품을 합리적인 가격에, KF365</p>
                        </div>
                    </div>

                    <div class="product-information">
                        <span class="product-information-value">2,480</span>
                    ...
                    <div class="sales-content">
                        ...
                        <dl class="sales-content-list">
                            ...
                            <dd class="sales-content-list-child2">
                                <p class="sales-content-list-p">냉장 (종이포장)</p>
                        ...
                        <dl class="sales-content-list">
                            ...
                            <dd class="sales-content-list-child2">
                                <p class="sales-content-list-p">1봉</p>
                            </dd>
                        </dl>
                        ...
                        <dl class="sales-content-list">
                            ...
                            <dd class="sales-content-list-child2">
                                <p class="sales-content-list-p">2입</p>
                            </dd>
                        </dl>
                        ...
                        <dl class="sales-content-list">
                            ...
                            <dd class="sales-content-list-child2">
                                <p class="sales-content-list-p">국산</p>
                            </dd>
                        </dl>
                        ...
                        <div class="product-selection-frame">
                            <dl class="product-selection">
                                ...
                                <div class="product-selection-detail-page">
                                    <div class="product-name"><span>[KF365] 가지 2입</span></div>
                                    <span>적립제외상품</span>
            ...
            <div class="product-description-frame">
                    ...
                    <div class="gaji-description-1">
                        <div class="gaji-description-2">
                            ...
                            <div class="gaji-intro">
                                <div class="gaji-pic">
                                    <img src="${contextPath}/컬리이미지/가지-상세페이지/gaji (1).jpg" alt="가지">
                                </div>
                            ...
                            <div class="gaji-point">
                                ...
                                <div class="gaji-context">
                                    <div class="gaji-pic">
                                        <img src="${contextPath}/컬리이미지/가지-상세페이지/gaji (2).jpg" alt="가지 성분">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="gaji-desc">
                                <div class="gaji-context">
                                    <div class="gaji-pic">
                                        <img src="${contextPath}/컬리이미지/기타/gaji-ad.webp" alt="광고">
                                    </div>
                                </div>
                            </div>
                ...
                <div class="gaji-detail">
                    <div class="gaji-detail-list1"><img src="${contextPath}/컬리이미지/가지-상세페이지/gaji.jpg" alt="크기사진"></div>
            ...
            <div class="item-quantity-information-three-frame">
                <div class="item-input-shoppingback-frame">
                    <div class="item-input-shoppingback-area">
                        <button type="button" class="heart-img iconImg" onclick="addwish(this.form);">
                            <span>
                                <img src="${contextPath}/컬리이미지/기타/heart.svg" alt="하트">
                            </span>
                        </button>
